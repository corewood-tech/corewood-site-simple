                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-12">
                            {services.map((service, index) => (
                                <div
                                    key={index}
                                    className="bg-[#386641]/5 rounded-lg p-8 transition-all hover:shadow-lg border border-[#386641]/10"
                                >
                                    <h2 className="text-2xl md:text-3xl font-display font-bold tracking-tight mb-4 text-[#386641]">
                                        {service.title}
                                    </h2>
